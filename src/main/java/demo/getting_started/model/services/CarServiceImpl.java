...
public class CarServiceImpl implements CarService {
   ...
   public CarServiceImpl() {
      carList.add(new Car(id++, "Primera", "Nissan",
                          ...
                          "/widgets/getting_started/img/car1.png", 23320, new SortableColour(Color.WHITE, "White")
      ));
      carList.add(new Car(id++, "Cefiro", "Nissan",
                          ...
                          "/widgets/getting_started/img/car2.png", 38165, new SortableColour(Color.BLACK, "Black")
      ));
      carList.add(new Car(id++, "Camry", "Toyota",
                          ...
                          "/widgets/getting_started/img/car3.png", 24170, new SortableColour(Color.GREEN, "Green")
      ));
      carList.add(new Car(id++, "Century", "Toyota",
                          ...
                          "/widgets/getting_started/img/car4.png", 28730, new SortableColour(Color.BLACK, "Black")
      ));
      ...
      carList.add(new Car(id++, "Challenger", "Mitsubishi",
                          ...
                          "/widgets/getting_started/img/car6.png", 58750, new SortableColour(Color.GREEN, "Green")
      ));
      ...
      carList
            .add(new Car(id++, "New Beetle", "Volkswagen", " The Volkswagen Beetle is produced since 1998. It is available as a coupe or convertible."
                  ...
                  + " The new Beetle has nothing in common with the rear-engined original, except the 'retro' design. It is based on the VW Golf and has the same solid build quality.",
                         "/widgets/getting_started/img/car2.png", 67540, new SortableColour(Color.YELLOW, "Yellow")
            ));
   ...
   public List<Car> search(String keyword) {
      ...
      if(keyword == null || "".equals(keyword)) {
         ...
         for(Car c : carList) {
            if(c.getModel().toLowerCase().contains(keyword.toLowerCase()) || c.getMake().toLowerCase().contains(keyword.toLowerCase())) {
               result.add(c);
            }
         }
      }
